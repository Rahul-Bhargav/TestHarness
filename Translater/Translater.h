...
// ver 1.0                                                             //
// Bhargav Rhaul Surabhi, CSE687 - Object Oriented Design, Spring 2018 //
...
*  CsMessage.h  TestRequest  TestRequestMessage
*  Required References:
* ----------------------
*  CommLibWrapper.dll
*  Message.lib
...
* ----------------------
*  ver 2.0 : 3/27/2018
	-added support for test request message
*  ver 1.0 : 3/27/2018
*  - first release
*/
...
namespace MsgPassingCommunication
{
  ...
  inline CsMessage^ Translater::GetTestRequestMessage(String^ Author, String^ Name, List<String^>^ dllFiles)
  {
	  ...
	  TestRequestMessage testReqMsg(testReq);
